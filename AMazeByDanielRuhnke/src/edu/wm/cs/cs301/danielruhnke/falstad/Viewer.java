...
public interface Viewer {
	 ...
	 * @param stopped accounts for whether or not the robot is stopped
	 * @param battery the battery used by the robot
	 * @param path the number of steps the robot took
	 */
	public void redraw(/*Graphics gc*/GraphicsWrapper panel, int state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, 
			int ang, boolean stopped, float battery, int path) ;
	/** 
