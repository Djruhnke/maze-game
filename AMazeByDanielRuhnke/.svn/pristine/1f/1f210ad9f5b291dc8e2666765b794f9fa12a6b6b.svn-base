...
public class Seg {
	...
	Seg(int psx, int psy, int pdx, int pdy, int cl, int cc) {
		...
		switch (part2) {
		case 0: /*col = new Color(val1, 20, 20)*/col = new WrapperColor(val1, 20, 20); break;
		case 1: /*col = new Color(20, val1, 20)*/col = new WrapperColor(20, val1, 20); break;
		case 2: /*col = new Color(20, 20, val1)*/col = new WrapperColor(20, 20, val1); break;
		case 3: /*col = new Color(val1, val1, 20)*/col = new WrapperColor(val1, val1, 20); break;
		case 4: /*col = new Color(20, val1, val1)*/col = new WrapperColor(20, val1, val1); break;
		case 5: /*col = new Color(val1, 20, val1)*/col = new WrapperColor(val1, 20, val1); break;
		default: /*col = new Color(20, 20, 20)*/col = new WrapperColor(20, 20, 20); break;
		}
	}
