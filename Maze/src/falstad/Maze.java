...
public class Maze  {
	...
	public void build(int skill, String mazeBuild) {
		...
		else if (mazeBuild == "Eller"){
			mazebuilder = new MazeBuilderEller();
		}
		
		else if (mazeBuild == "Prim"){
	...
	public boolean keyDown(int key) {
		...
		case Constants.STATE_PLAY:
			switch (key) {
			case /*Event.UP*/GraphicsWrapper.UP: case 'k': case '8':
				walk(1);
				break;
			case /*Event.LEFT*/GraphicsWrapper.LEFT: case 'h': case '4':
				rotate(1);
				break;
			case /*Event.RIGHT*/GraphicsWrapper.RIGHT: case 'l': case '6':
				rotate(-1);
				break;
			case /*Event.DOWN*/GraphicsWrapper.DOWN: case 'j': case '2':
				walk(-1);
				break;
